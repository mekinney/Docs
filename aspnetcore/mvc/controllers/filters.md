...
*Filters* in ASP.NET MVC allow you to run code before or after certain stages in the request processing pipeline. Filters can run code for every request, for selected controllers, or for selected action methods.
